...
<PlotlyBrowserLoader
  chartUrl={useBaseUrl('/charts/ubiquitin-simple.json')}
...
<PlotlyBrowserLoader
  chartUrl={useBaseUrl('/charts/ubiquitin-two.json')}
  style={{ width: '90%', height: '500px' }}
/>
...
<PlotlyBrowserLoader
  chartUrl={useBaseUrl('/charts/ubiquitin-mass.json')}
  style={{ width: '90%', height: '500px' }}
/>
...
<PlotlyBrowserLoader
  chartUrl={useBaseUrl('/charts/hemoglobin-mz.json')}
  style={{ width: '90%', height: '500px' }}
/>

<PlotlyBrowserLoader
  chartUrl={useBaseUrl('/charts/hemoglobin-mass.json')}
  style={{ width: '90%', height: '500px' }}
/>
